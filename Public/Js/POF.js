...
function actualizarPaginacion() {
    ...
    var terminoBusqueda = encodeURIComponent($("#buscar").val());

    // Redirige a la página de resultados de búsqueda con la paginación
    window.location.href = 'POF.php?pagina=1&busqueda=' + terminoBusqueda;
}
